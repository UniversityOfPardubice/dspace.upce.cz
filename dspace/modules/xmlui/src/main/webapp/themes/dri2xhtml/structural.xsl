    ...
    <xsl:template name="buildHeader">
        ...
        <div id="ds-header-image">
           ...
           <xsl:attribute name="href">
              ...
              <img border="0">
                 <xsl:attribute name="src">
                    <xsl:value-of select="concat($theme-path,'/images/header_upce.jpg')"/>
                 </xsl:attribute>
              </img>
           </a>
        </div>
                        ...
                        <xsl:if test="count(/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='page'][@qualifier='supportedLocale']) &gt; 1">
                                <div id="ds-language-selection">
                                        <xsl:for-each select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='page'][@qualifier='supportedLocale']">
                                                ...
                                                <a>
                                                <xsl:attribute name="href">
                                                        <xsl:value-of select="concat('','?locale-attribute=')"/>
        ...
        <div id="ds-options">
            ...
            <div id="ds-search-option" class="ds-option-set">
                ...
                <form id="ds-search-form" method="post">
                    ...
                    <fieldset>
                        <input class="ds-text-field-search " type="text">
                            <xsl:attribute name="name">
                                <xsl:value-of select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='search'][@qualifier='queryField']"/>
                            </xsl:attribute>
                        </input>
                        <input class="ds-button-field-search " name="submit" type="image" i18n:attr="value" value="xmlui.general.go" >
                            <xsl:attribute name="src">
                                <xsl:value-of select="concat($theme-path,'/images/search-blank.png')"/>
                            </xsl:attribute>
