    ...
    <xsl:template match="dim:dim" mode="itemSummaryList-DIM"> 
        ...
        <div class="artifact-description">
            ...
            <div class="artifact-info">
                <span class="author">
                <!-- TODO TOHLE JSEM PRIDAL -->
                <strong><i18n:text>xmlui.dri2xhtml.METS-1.0.item-author</i18n:text>: </strong>
                    <xsl:choose>
                    ...
                    <xsl:choose>
                        <xsl:when test="dim:field[@element='type']">
                            <div class="artifact-type">
                            	<strong><i18n:text>xmlui.dri2xhtml.METS-1.0.item-type</i18n:text>: </strong> <xsl:value-of select="dim:field[@element='type'][1]/node()"/>
                            </div>
                        </xsl:when>
                    </xsl:choose>
                    <xsl:choose>
                        <xsl:when test="dim:field[@element='rights']">
                        	<div class="artifact-rights">
                        		<strong><i18n:text>xmlui.dri2xhtml.METS-1.0.item-rights</i18n:text>: </strong> <xsl:value-of select="dim:field[@element='rights'][1]/node()"  disable-output-escaping="yes"  />
                        	</div>
                        </xsl:when>
                    </xsl:choose>
...
<script type="text/javascript" src="http://s7.addthis.com/js/250/addthis_widget.js#pubid=xa-4f4f70660249d5c9">var aaa;</script>
<!-- AddThis Button END -->
    ...
    <xsl:template name="itemSummaryView-DIM-fields">
      ...
      <xsl:choose>
          ...
          <xsl:when test="$clause = 2 and (dim:field[@element='title'][@qualifier='alternative'])">
            <tr class="ds-table-row {$phase}">
                ...
                <td>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <i18n:text>xmlui.dri2xhtml.METS-1.0.no-title-alternative</i18n:text>
                        </xsl:otherwise>
                    </xsl:choose>
                </td>
            </tr>
            <xsl:call-template name="itemSummaryView-DIM-fields">
              ...
              <xsl:with-param name="phase" select="$otherPhase"/>
                    ...
                    <!-- Author(s) row -->
          <xsl:when test="$clause = 3 and (dim:field[@element='contributor'][@qualifier='author'] or dim:field[@element='creator'] or dim:field[@element='contributor'])">
                    <tr class="ds-table-row {$phase}">
          ...
          <!-- Advisor(s) row -->
          <xsl:when test="$clause = 4 and (dim:field[@element='contributor'][@qualifier='advisor'])">
                    <tr class="ds-table-row {$phase}">
	                <td><span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-advisor</i18n:text>:</span></td>
	                <td>
	                    <xsl:choose>
	                        ...
	                        <xsl:otherwise>
	                            <i18n:text>xmlui.dri2xhtml.METS-1.0.no-advisor</i18n:text>
	                        </xsl:otherwise>
	                    </xsl:choose>
	                </td>
	            </tr>
          ...
          <!-- dc.type row -->
          <xsl:when test="$clause = 6  and (dim:field[@element='type'][not(@qualifier)])">
            <tr class="ds-table-row {$phase}">
                <td><span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-type</i18n:text>: </span></td>
                <td>
                        <xsl:choose>
                            <xsl:when test="count(dim:field[@element='type'][not(@qualifier)]) &gt; 1">
                            ...
                            <xsl:otherwise>
                                <i18n:text>xmlui.dri2xhtml.METS-1.0.no-type</i18n:text>
                            </xsl:otherwise>
                        </xsl:choose>
                </td>
            </tr>
          ...
          <!-- dc.thesis-degree-discipline row -->
          <xsl:when test="$clause = 7  and (dim:field[@element='thesis'][@qualifier='degree-discipline'])">
            <tr class="ds-table-row {$phase}">
                <td><span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-thesis-degree-discipline</i18n:text>: </span></td>
                <td>
                        <xsl:choose>
                            <xsl:when test="count(dim:field[@element='thesis'][@qualifier='degree-discipline']) &gt; 1">
                                <xsl:for-each select="dim:field[@element='thesis'][@qualifier='degree-discipline']">
                            	   <xsl:value-of select="./node()"/>
                            	   <xsl:if test="count(following-sibling::dim:field[@element='thesis'][@qualifier='degree-discipline']) != 0">
	                                    <xsl:text>; </xsl:text><br/>
	                                </xsl:if>
                                </xsl:for-each>
                            </xsl:when>
                            <xsl:when test="count(dim:field[@element='thesis'][@qualifier='degree-discipline']) = 1">
                                <xsl:value-of select="dim:field[@element='thesis'][@qualifier='degree-discipline'][1]/node()"/>
                            </xsl:when>
                            <xsl:otherwise>
                                <i18n:text>xmlui.dri2xhtml.METS-1.0.no-thesis-degree-discipline</i18n:text>
                            </xsl:otherwise>
                        </xsl:choose>
                </td>
            </tr>
          ...
          <!-- dc.identifier.signature row -->
          <xsl:when test="$clause = 8  and (dim:field[@element='identifier'][@qualifier='signature'])">
            <tr class="ds-table-row {$phase}">
                <td><span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-identifier-signature</i18n:text>: </span></td>
                <td>
                        <xsl:choose>
                            <xsl:when test="count(dim:field[@element='identifier'][@qualifier='signature']) &gt; 1">
                                <xsl:for-each select="dim:field[@element='identifier'][@qualifier='signature']">
                            	   <xsl:value-of select="./node()"/>
                            	   <xsl:if test="count(following-sibling::dim:field[@element='identifier'][@qualifier='signature']) != 0">
	                                    <xsl:text>; </xsl:text><br/>
	                                </xsl:if>
                                </xsl:for-each>
                            </xsl:when>
                            <xsl:when test="count(dim:field[@element='identifier'][@qualifier='signature']) = 1">
                                <xsl:value-of select="dim:field[@element='identifier'][@qualifier='signature'][1]/node()"/>
                            </xsl:when>
                            <xsl:otherwise>
                                <i18n:text>xmlui.dri2xhtml.METS-1.0.no-identifier-signature</i18n:text>
                            </xsl:otherwise>
                        </xsl:choose>
                </td>
            </tr>
          ...
          <!-- dc.identifier row -->
          <xsl:when test="$clause = 9 and (dim:field[@element='identifier'][not(@qualifier)])">
            <tr class="ds-table-row {$phase}">
                <td><span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-identifier</i18n:text>: </span></td>
                <td>
                        <xsl:choose>
                            <xsl:when test="count(dim:field[@element='identifier'][not(@qualifier)]) &gt; 1">
                            ...
                            <xsl:otherwise>
                                <i18n:text>xmlui.dri2xhtml.METS-1.0.no-identifier</i18n:text>
                            </xsl:otherwise>
                        </xsl:choose>
                </td>
            </tr>
          ...
          <!-- dc.rights row -->
          <xsl:when test="$clause = 10 and (dim:field[@element='rights'][not(@qualifier)])">
            <tr class="ds-table-row {$phase}">
                <td><span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-rights</i18n:text>: </span></td>
                <td>
                        <xsl:choose>
                            <xsl:when test="count(dim:field[@element='rights'][not(@qualifier)]) &gt; 1">
                            ...
                            <xsl:when test="count(dim:field[@element='rights'][not(@qualifier)]) = 1">
                                <xsl:value-of select="dim:field[@element='rights'][not(@qualifier)][1]/node()"/>
                            </xsl:when>
                            <xsl:otherwise>
                                <i18n:text>xmlui.dri2xhtml.METS-1.0.no-rights</i18n:text>
                            </xsl:otherwise>
                        </xsl:choose>
                </td>
            </tr>
          ...
          <!-- dc.rights.licence row -->
          <xsl:when test="$clause = 11 and (dim:field[@element='rights'][@qualifier='licence'])">
            <tr class="ds-table-row {$phase}">
                <td><span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-rights-licence</i18n:text>: </span></td>
                <td>
                        <xsl:choose>
                            <xsl:when test="count(dim:field[@element='rights'][@qualifier='licence']) &gt; 1">
                                <xsl:for-each select="dim:field[@element='rights'][@qualifier='licence']">
                            	   <xsl:value-of disable-output-escaping="yes" select="./node()"/>
                            	   <xsl:if test="count(following-sibling::dim:field[@element='rights'][@qualifier='licence']) != 0">
	                                    <xsl:text>; </xsl:text><br/>
	                                </xsl:if>
                                </xsl:for-each>
                            </xsl:when>
                            <xsl:when test="count(dim:field[@element='rights'][@qualifier='licence']) = 1">
                                <xsl:value-of disable-output-escaping="yes" select="dim:field[@element='rights'][@qualifier='licence'][1]/node()"/>
                            </xsl:when>
                            <xsl:otherwise>
                                <i18n:text>xmlui.dri2xhtml.METS-1.0.no-rights-licence</i18n:text>
                            </xsl:otherwise>
                        </xsl:choose>
                </td>
            </tr>
          ...
          <!-- dc.rights.physicalunit row -->
          <xsl:when test="$clause = 13  and (dim:field[@element='rights'][@qualifier='physicalunit'])">
            <tr class="ds-table-row {$phase}">
                <td><span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-rights-physicalunit</i18n:text>: </span></td>
                <td>
                        <xsl:choose>
                            <xsl:when test="count(dim:field[@element='rights'][@qualifier='physicalunit']) &gt; 1">
                                <xsl:for-each select="dim:field[@element='rights'][@qualifier='physicalunit']">
                            	   <xsl:value-of select="./node()"/>
                            	   <xsl:if test="count(following-sibling::dim:field[@element='rights'][@qualifier='physicalunit']) != 0">
	                                    <xsl:text>; </xsl:text><br/>
	                                </xsl:if>
                                </xsl:for-each>
                            </xsl:when>
                            <xsl:when test="count(dim:field[@element='rights'][@qualifier='physicalunit']) = 1">
                                <xsl:value-of select="dim:field[@element='rights'][@qualifier='physicalunit'][1]/node()"/>
                            </xsl:when>
                            <xsl:otherwise>
                                <i18n:text>xmlui.dri2xhtml.METS-1.0.no-rights-physicalunit</i18n:text>
                            </xsl:otherwise>
                        </xsl:choose>
                </td>
            </tr>
          ...
          <!-- dc.identifier.issn row -->
          <xsl:when test="$clause = 14  and (dim:field[@element='identifier'][@qualifier='issn'])">
            <tr class="ds-table-row {$phase}">
                <td><span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-identifier-issn</i18n:text>: </span></td>
                <td>
                        <xsl:choose>
                            <xsl:when test="count(dim:field[@element='identifier'][@qualifier='issn']) &gt; 1">
                            ...
                            <xsl:when test="count(dim:field[@element='identifier'][@qualifier='issn']) = 1">
                                <xsl:value-of select="dim:field[@element='identifier'][@qualifier='issn'][1]/node()"/>
                            </xsl:when>
                            <xsl:otherwise>
                                <i18n:text>xmlui.dri2xhtml.METS-1.0.no-identifier-issn</i18n:text>
                            </xsl:otherwise>
                        </xsl:choose>
                </td>
            </tr>
          ...
          <!-- dc.relation.ispartof row -->
          <xsl:when test="$clause = 15  and (dim:field[@element='relation'][@qualifier='ispartof'])">
            <tr class="ds-table-row {$phase}">
                <td><span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-relation-ispartof</i18n:text>: </span></td>
                <td>
                        <xsl:choose>
                            <xsl:when test="count(dim:field[@element='relation'][@qualifier='ispartof']) &gt; 1">
                            ...
                            <xsl:when test="count(dim:field[@element='relation'][@qualifier='ispartof']) = 1">
                                <xsl:value-of select="dim:field[@element='relation'][@qualifier='ispartof'][1]/node()"/>
                            </xsl:when>
                            <xsl:otherwise>
                                <i18n:text>xmlui.dri2xhtml.METS-1.0.no-relation-ispartof</i18n:text>
                            </xsl:otherwise>
                        </xsl:choose>
                </td>
            </tr>
          ...
          <!-- dc.relation row -->
          <xsl:when test="$clause = 16  and (dim:field[@element='relation'][not(@qualifier)])">
            <tr class="ds-table-row {$phase}">
                <td><span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-relation</i18n:text>: </span></td>
                <td>
                        <xsl:choose>
                            <xsl:when test="count(dim:field[@element='relation'][not(@qualifier)]) &gt; 1">
                            ...
                            <xsl:when test="count(dim:field[@element='relation'][not(@qualifier)]) = 1">
                                <xsl:value-of disable-output-escaping="yes" select="dim:field[@element='relation'][not(@qualifier)][1]/node()"/>
                            </xsl:when>
                            <xsl:otherwise>
                                <i18n:text>xmlui.dri2xhtml.METS-1.0.no-relation</i18n:text>
                            </xsl:otherwise>
                        </xsl:choose>
                </td>
            </tr>
          ...
          <!-- dc.peerreviewed row -->
          <xsl:when test="$clause = 17  and (dim:field[@element='peerreviewed'][not(@qualifier)])">
            <tr class="ds-table-row {$phase}">
                <td><span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-peerreviewed</i18n:text>: </span></td>
                <td>
                        <xsl:choose>
                            <xsl:when test="count(dim:field[@element='peerreviewed'][not(@qualifier)]) &gt; 1">
                                <xsl:for-each select="dim:field[@element='peerreviewed'][not(@qualifier)]">
                            	   <xsl:value-of select="./node()"/>
                            	   <xsl:if test="count(following-sibling::dim:field[@element='peerreviewed'][not(@qualifier)]) != 0">
	                                    <xsl:text>; </xsl:text><br/>
	                                </xsl:if>
                                </xsl:for-each>
                            </xsl:when>
                            <xsl:when test="count(dim:field[@element='peerreviewed'][not(@qualifier)]) = 1">
                                <xsl:value-of select="dim:field[@element='peerreviewed'][not(@qualifier)][1]/node()"/>
                            </xsl:when>
                            <xsl:otherwise>
                                <i18n:text>xmlui.dri2xhtml.METS-1.0.no-peerreviewed</i18n:text>
                            </xsl:otherwise>
                        </xsl:choose>
                </td>
            </tr>
          ...
          <!-- dc.publicationstatus row -->
          <xsl:when test="$clause = 18  and (dim:field[@element='publicationstatus'][not(@qualifier)])">
            <tr class="ds-table-row {$phase}">
                <td><span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-publicationstatus</i18n:text>: </span></td>
                <td>
                        <xsl:choose>
                            <xsl:when test="count(dim:field[@element='publicationstatus'][not(@qualifier)]) &gt; 1">
                                <xsl:for-each select="dim:field[@element='publicationstatus'][not(@qualifier)]">
                            	   <xsl:value-of select="./node()"/>
                            	   <xsl:if test="count(following-sibling::dim:field[@element='publicationstatus'][not(@qualifier)]) != 0">
	                                    <xsl:text>; </xsl:text><br/>
	                                </xsl:if>
                                </xsl:for-each>
                            </xsl:when>
                            <xsl:when test="count(dim:field[@element='publicationstatus'][not(@qualifier)]) = 1">
                                <xsl:value-of select="dim:field[@element='publicationstatus'][not(@qualifier)][1]/node()"/>
                            </xsl:when>
                            <xsl:otherwise>
                                <i18n:text>xmlui.dri2xhtml.METS-1.0.no-publicationstatus</i18n:text>
                            </xsl:otherwise>
                        </xsl:choose>
                </td>
            </tr>
          ...
          <!-- dc.event row -->
          <xsl:when test="$clause = 19  and (dim:field[@element='event'][not(@qualifier)])">
            <tr class="ds-table-row {$phase}">
                <td><span class="bold"><i18n:text>xmlui.dri2xhtml.METS-1.0.item-event</i18n:text>: </span></td>
                <td>
                        <xsl:choose>
                            <xsl:when test="count(dim:field[@element='event'][not(@qualifier)]) &gt; 1">
                                <xsl:for-each select="dim:field[@element='event'][not(@qualifier)]">
                            	   <xsl:value-of select="./node()"/>
                            	   <xsl:if test="count(following-sibling::dim:field[@element='event'][not(@qualifier)]) != 0">
	                                    <xsl:text>; </xsl:text><br/>
	                                </xsl:if>
                                </xsl:for-each>
                            </xsl:when>
                            <xsl:when test="count(dim:field[@element='event'][not(@qualifier)]) = 1">
                                <xsl:value-of select="dim:field[@element='event'][not(@qualifier)][1]/node()"/>
                            </xsl:when>
                            <xsl:otherwise>
                                <i18n:text>xmlui.dri2xhtml.METS-1.0.no-event</i18n:text>
                            </xsl:otherwise>
                        </xsl:choose>
                </td>
            </tr>
    ...
    <xsl:template name="collectionDetailView-DIM">
    		<!-- TODO TOHLE JSEM TADY DODELAL -->
    		<!-- Prohledat tuto kolekci: -->
<div style="float:left">
    		<h2><i18n:text>xmlui.ArtifactBrowser.Navigation.head_browse</i18n:text>:</h2>
    		<ul>
        		<li><a href="{@OBJID}/browse?type=dateissued"><i18n:text>xmlui.ArtifactBrowser.Navigation.browse_dateissued</i18n:text></a></li>
        		<li><a href="{@OBJID}/browse?type=author"><i18n:text>xmlui.ArtifactBrowser.Navigation.browse_author</i18n:text></a></li>
        		<li><a href="{@OBJID}/browse?type=title"><i18n:text>xmlui.ArtifactBrowser.Navigation.browse_title</i18n:text></a></li>
        		<li><a href="{@OBJID}/browse?type=subject"><i18n:text>xmlui.ArtifactBrowser.Navigation.browse_subject</i18n:text></a></li>
    		</ul>
</div>
  ...
  <!--          <xsl:apply-templates select="./mets:fileSec/mets:fileGrp[@USE='LOGO']"/>-->
    ...
    <xsl:template match="dim:dim" mode="collectionDetailView-DIM"> 
        <xsl:if test="string-length(dim:field[@element='description'][not(@qualifier)])&gt;0">
            <p class="intro-text">
                <xsl:value-of disable-output-escaping="yes" select="dim:field[@element='description'][not(@qualifier)]/node()"/>
            </p>
        </xsl:if>
